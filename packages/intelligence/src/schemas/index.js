...
exports.DomainSchema = exports.RecommendationSchema = exports.DecisionSchema = exports.ScoreSchema = exports.InsightSchema = exports.FactSchema = exports.QuestionSchema = exports.QuestionOptionSchema = void 0;
...
exports.QuestionSchema = zod_1.z.object({
    ...
    type: zod_1.z.enum(['single-choice', 'multiple-choice', 'slider', 'number', 'boolean', 'height', 'weight', 'text', 'time', 'scale']),
