  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`text-slate-400 flex-shrink-0 transition-transform duration-300 ${isOpen ? 'rotate-180' : 'rotate-0'}`}
        >
      ...
      >
        <div className="overflow-hidden">
          <div className="px-6 pb-6 pt-0 text-slate-600 dark:text-slate-400 border-t border-slate-100 dark:border-slate-800/50 mt-2">
            <p className="mb-2 font-medium text-slate-700 dark:text-slate-300 pt-4">
              Why this matters:
            </p>
