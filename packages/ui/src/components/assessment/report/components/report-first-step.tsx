        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 gap-4 mb-8">
            <div className="bg-white/60 dark:bg-slate-900/60 p-4 rounded-xl border border-white/20 dark:border-slate-800/20 backdrop-blur-sm shadow-sm">
              <span className="block text-xs uppercase text-slate-500 dark:text-slate-400 font-semibold mb-1">
                Effort
              </span>
          ...
          <Link
            href={`/action-hub/guide-morning-energy`}
            prefetch={true}
            className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-3 px-8 rounded-full transition-all duration-300 focus:outline-none focus-visible:ring-4 focus-visible:ring-indigo-600/30 hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0"
          >
            Open Your Playbook
          </Link>
        </div>
