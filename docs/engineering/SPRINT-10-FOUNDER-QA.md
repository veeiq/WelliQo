...
- **WhatsApp Integration**: A `<FloatingWhatsApp />` button is mounted globally in the RootLayout, pre-filled with the message: _"Hi, I was exploring WelliQo and would like some guidance regarding my wellness journey."_
