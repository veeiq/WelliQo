...
- **Layer 1 (Information Architecture)** answers: _"Where does this content live?"_
- **Layer 2 (Knowledge Layer)** answers: _"What is this content connected to?"_
...
- **Layer 2 Discovery**: At the bottom of an article, the UI dynamically generates:
  - _"Next Step"_ (driven by `progresses_to`)
  - _"The Science Behind It"_ (driven by `explains`)
  - _"Required Habits"_ (driven by `requires`)
  - _"Common Goals"_ (driven by `improves`)
