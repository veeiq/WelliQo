...
export const COACHES: Coach[] = [
  ...
  },
  {
    ...
    fullBio: "Priyadarshini focuses on sustainable, realistic nutritional interventions that fit into everyday life. She is an advocate for holistic wellness, believing that mental resilience and physical health are deeply interconnected. Nourishment isn't just about what you eat; it's about how you digest, move, and think."
  },
  {
    id: 'coach-dipti',
    slug: 'dipti',
    ...
    fullBio: "Dipti specializes in women's health, focusing on hormonal balance, postpartum recovery, and sustainable energy management. Her compassionate approach helps clients build resilience and vitality through mindful habit changes."
  }
];
