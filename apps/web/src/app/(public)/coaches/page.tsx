    ...
    <main className="container py-16 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {COACHES.map((coach) => (
          <div
            key={coach.id}
            className="bg-[var(--color-background-secondary)] rounded-3xl p-8 border border-[var(--color-border-subtle)] flex flex-col h-full hover:shadow-lg transition-all hover:border-[var(--color-accent-primary)]"
          >
            <div className="flex items-start gap-6 mb-6">
              ...
              <div>
                ...
                <p className="text-[var(--color-accent-primary)] font-medium mb-3">
                  {coach.expertise}
                </p>
            ...
            <p className="text-[var(--color-text-secondary)] mb-8 flex-1">{coach.shortIntro}</p>
        ...
        <div className="bg-slate-50 dark:bg-slate-900/50 rounded-3xl p-8 border-2 border-dashed border-slate-300 dark:border-slate-700 flex flex-col h-full items-center justify-center text-center">
          ...
          <a
            ...
            className="bg-slate-800 dark:bg-slate-200 text-white dark:text-slate-900 px-8 py-3 rounded-xl font-semibold hover:opacity-90 transition-opacity"
          >
            Apply Now
          </a>
        </div>
