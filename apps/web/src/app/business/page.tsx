  ...
  const benefits = [
    {
      ...
      description: 'Join a worldwide network of wellness coaches.',
    },
    {
      title: 'Financial Independence',
      icon: <LineChart className="w-6 h-6" />,
      description: 'Build your own business on your own terms.',
    },
    {
      title: 'Mentorship',
      icon: <Users className="w-6 h-6" />,
      description: 'Receive guidance from experienced business builders.',
    },
  ];
      ...
      <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl leading-relaxed text-balance">
            Help others achieve their wellness goals while building a sustainable business of your
            own.
          </p>
        </div>
      </div>
            ...
            <section>
              ...
              <div className="prose prose-slate dark:prose-invert max-w-none">
                <p className="text-lg leading-relaxed text-slate-600 dark:text-slate-400">
                  The wellness industry is growing rapidly, driven by people looking for holistic,
                  science-backed solutions to improve their daily lives. By becoming a wellness
                  coach, you are stepping into a role of leadership and care.
                </p>
                <p className="text-lg leading-relaxed text-slate-600 dark:text-slate-400 mt-4">
                  You don&apos;t just sell products; you guide individuals on their journey,
                  interpreting their needs, and providing the support required to build lasting
                  healthy habits.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                {benefits.map((benefit, idx) => (
                  <div
                    key={idx}
                    className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800 flex flex-col items-center text-center"
                  >
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 text-center">
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-8">
                Information regarding starter kits, compensation plans, and early training will be
                available here soon.
              </p>
              <button
                disabled
                className="w-full bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 font-medium px-6 py-3 rounded-full cursor-not-allowed"
              >
