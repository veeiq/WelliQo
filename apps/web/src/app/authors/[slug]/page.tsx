...
export default async function AuthorPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="container py-12 max-w-4xl mx-auto">
      <Link href="/learn" className="text-[var(--color-accent-primary)] hover:underline mb-8 inline-block font-medium">
      ...
      <div className="bg-[var(--color-background-secondary)] p-8 rounded-3xl border border-[var(--color-border-subtle)] mb-12">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-[var(--color-text-primary)]">{coachNode.title}</h1>
      ...
      <div className="mb-12">
        <h2 className="text-2xl font-bold text-[var(--color-text-primary)] mb-6">Articles & Guides by {coachNode.title}</h2>
