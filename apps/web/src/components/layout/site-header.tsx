        ...
        <div className="container mx-auto px-4 md:px-8 flex h-[72px] items-center justify-between">
          ...
          <div className="hidden lg:flex flex-1 justify-center px-8">
            <nav className="flex items-center gap-6 bg-slate-100/50 dark:bg-slate-900/50 px-6 py-2 rounded-full border border-slate-200/50 dark:border-slate-800/50 backdrop-blur-md">
              ...
              <Link href="/coaches" className={`text-sm font-medium transition-colors ${pathname?.startsWith('/coaches') ? 'text-emerald-600 dark:text-emerald-400 underline underline-offset-[6px] decoration-2 decoration-emerald-500/40 dark:decoration-emerald-400/40' : 'text-slate-600 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400'}`}>Coaches</Link>
      ...
      >
        ...
        <div className="p-4 overflow-y-auto flex-1">
          ...
          <nav className="flex flex-col gap-3">
            ...
            <Link href="/coaches" onClick={() => setIsMobileMenuOpen(false)} className={`flex items-center gap-3 p-3 rounded-xl text-base font-medium transition-colors ${pathname?.startsWith('/coaches') ? 'bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400' : 'text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800/50 hover:text-emerald-600 dark:hover:text-emerald-400'}`}>
              <User className={`w-[22px] h-[22px] ${pathname?.startsWith('/coaches') ? 'text-emerald-500' : ''}`} /> Coaches
            </Link>
